          ...
          <div className="space-y-6">
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <div className="text-left">
                <h1 className="text-4xl font-bold">Bulldozer Brain</h1>
                <p className="text-xl text-muted-foreground font-medium">Local 825</p>
              </div>
            </div>

            <h2 className="text-2xl md:text-3xl font-semibold text-foreground max-w-3xl mx-auto">
              AI-Powered Labor Organizing Research Platform
            </h2>

            <p className="text-lg text-muted-foreground max-w-2xl mx-auto leading-relaxed">
              Advanced research tools for Local 825 organizers. Analyze companies, investigate corporate structures, 
              access public documents, and generate comprehensive company profiles for strategic organizing.
            </p>
          </div>
            ...
            <form onSubmit={handleSearch}>
              <div className="relative">
                <input
                  type="text"
                  name="query"
                  placeholder="Research companies, analyze contracts, investigate labor violations..."
